...
def flac2wav():
    ...
    flac_path = str(os.getcwd()) + '/data/voice/flac/'
    wav_path = str(os.getcwd()) + '/data/voice/wav/'
...
# create the training.txt and testing.txt files for both classes
def create_splits():
    
    voice_wavs = 'data/voice/wav/'
    not_voice_wavs = 'data/not_voice/wav/'
...
def get_csv(csv_name, data_split, annotations_path):
    ...
    shutil.move(str(csv_name), os.path.abspath(annotations_path))
    return
